...
class Parasite:
    ...
    def __init__(self, linktype=''):
        ...
        if linktype == 'Featured' or linktype == 'featured' or linktype == 'FEATURED':
            chrome_options.add_argument(
...
# url_x = "https://support.halabtech.com/index.php?a=downloads&b=file&id=529592"
# url_x = "https://support.halabtech.com/index.php?a=downloads&b=file&c=download&id=529592"


# parasite = Parasite(linktype='Featured')
# for i in range(2):

#     a__ = parasite.CrackedMindBot(url, open_only_browser=None)
#     print(a__)
#     print("End:",parasite.end_url)


# plst = {'random5': [{'id': 13, 'hlink': 'https://support.halabtech.com/index.php?a=downloads&b=file&c=download&id=529592'},
#                     {"id": 36, "hlink": "https://support.halabtech.com/index.php?a=downloads&b=file&c=download&id=504632"}]}
...
#     if len(plst) == 0:
#         continue
#     for cache_name in plst.keys():
#         try:
#             parasite = Parasite(linktype='Featured')  # cache_name
#             for url_ in plst[cache_name]:
#                 try:
#                     id = url_['id']
#                     hlink = url_['hlink']+"&c=download"
#                     parasite.CrackedMindBot(hlink, open_only_browser=None)
#                     print("EndResult:", parasite.end_url, "Id:", id)
#                     snd_final_to_server(id=id, dirlink=parasite.end_url)
